...
void Shape::normalizeCoordinates(Shape& shape, int width, int height) {
	for (glm::vec2& point : shape.points) {
		glm::vec2 normalizedPoint;
		normalizedPoint.x = point.x / width * 2 - 1;
		normalizedPoint.y = point.y / height * 2 - 1;
