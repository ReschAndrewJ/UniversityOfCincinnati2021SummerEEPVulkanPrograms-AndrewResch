...
void Buffers::createVertexBuffer(Devices& devices, SwapChain& swapChain, const Object& object) {
...
void Buffers::createIndexBuffer(Devices& devices, const Object& object) {
	size_t index = indexBuffers.size();
